...
public class Shield extends AbstractDefensiveItem {
	...
	@Override
	public Item clone() {
		return new Shield(id, name, amount, tradeable, graphic, value, usageDifficulty, manufactureDifficulty, forbiddenArchetypes, newbie, equippedGraphic, minDef, maxDef, minMagicDef, maxMagicDef);
	}
