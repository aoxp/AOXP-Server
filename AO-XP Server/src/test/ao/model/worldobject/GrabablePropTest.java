...
public class GrabablePropTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		ItemProperties props1 = new ItemProperties(WorldObjectType.GRABABLE_PROP, 1, "Black Potion", 1, true, 1, 0, null, null, false);
		prop1 = new GrabableProp(props1, 5);
		
		ItemProperties props2 = new ItemProperties(WorldObjectType.GRABABLE_PROP, 1, "Black Potion", 1, true, 1, 0, null, null, false);
