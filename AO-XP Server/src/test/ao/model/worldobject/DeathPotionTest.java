...
public class DeathPotionTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		ItemProperties props1 = new ItemProperties(WorldObjectType.DEATH_POTION, 1, "Black Potion", 1, true, 1, 0, null, null, false, false, false, true);
		potion1 = new DeathPotion(props1, 5);
		
		ItemProperties props2 = new ItemProperties(WorldObjectType.DEATH_POTION, 1, "Black Potion", 1, true, 1, 0, null, null, false, true, true, false);
