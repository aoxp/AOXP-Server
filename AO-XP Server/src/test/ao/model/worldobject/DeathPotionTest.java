...
public class DeathPotionTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		ItemProperties props1 = new ItemProperties(1, "Black Potion", 1, true, 1, 0, null, false);
		potion1 = new DeathPotion(props1, 5);
		
		ItemProperties props2 = new ItemProperties(1, "Black Potion", 1, true, 1, 0, null, false);
