...
public class ManaPotionTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		StatModifyingItemProperties props1 = new StatModifyingItemProperties(WorldObjectType.MANA_POTION, 1, "Blue Potion", 1, true, 1, 0, null, null, false, MIN_MANA, MAX_MANA);
		potion1 = new ManaPotion(props1, 5);
		
		StatModifyingItemProperties props2 = new StatModifyingItemProperties(WorldObjectType.MANA_POTION, 1, "Big Blue Potion", 1, true, 1, 0, null, null, false, MAX_MANA, MAX_MANA);
