...
public class FoodTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		StatModifyingItemProperties props1 = new StatModifyingItemProperties(1, "Apple", 1, true, 1, 0, null, false, MIN_HUN, MAX_HUN);
		food1 = new Food(props1, 5);
		
		StatModifyingItemProperties props2 = new StatModifyingItemProperties(1, "Green Apple", 1, true, 1, 0, null, false, MAX_HUN, MAX_HUN);
