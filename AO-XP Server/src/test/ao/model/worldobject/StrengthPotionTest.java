...
public class StrengthPotionTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		StatModifyingItemProperties props1 = new StatModifyingItemProperties(1, "Green Potion", 1, true, 1, 0, 0, null, false, MIN_STR, MAX_STR);
		potion1 = new StrengthPotion(props1, 5);
		
		StatModifyingItemProperties props2 = new StatModifyingItemProperties(1, "Big Green Potion", 1, true, 1, 0, 0, null, false, MAX_STR, MAX_STR);
