...
public class StrengthPotionTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		potion1 = new StrengthPotion(1, "Green Potion", 5, true, 1, 1, 0, 0, null, false, MIN_STR, MAX_STR);
		potion2 = new StrengthPotion(1, "Big Green Potion", 1, true, 1, 1, 0, 0, null, false, MAX_STR, MAX_STR);
