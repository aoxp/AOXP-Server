...
public class ParchmentTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		...
		ParchmentProperties props1 = new ParchmentProperties(WorldObjectType.PARCHMENT, 1, "Dardo Mágico", 1, 300, 0, null, null, false, false, false, false, spell1);
		parchment1 = new Parchment(props1, 1);
		
		spell2 = new Spell(new Effect[] {}, 0, 0, 0, "foo", "foo", false, 1, 2, "Rahma Nañarak O'al");
		ParchmentProperties props2 = new ParchmentProperties(WorldObjectType.PARCHMENT, 1, "Terrible hambre de Igor", 100, 200, 0, null, null, false, false, false, false, spell2);
