...
public class AmmunitionTest extends AbstractEquipableItemTest {
	...
	public void setUp() throws Exception {
		AmmunitionProperties props1 = new AmmunitionProperties(WorldObjectType.AMMUNITION, 1, "Arrow", 1, true, 1, 0, null, null, false, 1, MIN_HIT, MAX_HIT);
		ammunition1 = new Ammunition(props1, 5);
		
		AmmunitionProperties props2 = new AmmunitionProperties(WorldObjectType.AMMUNITION, 1, "Fire Arrow", 1, true, 1, 0, null, null, false, 1, MAX_HIT, MAX_HIT);
