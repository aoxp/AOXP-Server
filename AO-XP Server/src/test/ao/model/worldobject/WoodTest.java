...
public class WoodTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		WoodProperties props1 = new WoodProperties(WorldObjectType.WOOD, 1, "Black Potion", 1, true, 1, 0, null, null, false, false, false, false, WoodType.NORMAL);
		wood1 = new Wood(props1, 5);
		
		WoodProperties props2 = new WoodProperties(WorldObjectType.WOOD, 1, "Black Potion", 1, true, 1, 0, null, null, false, false, false, false, WoodType.ELVEN);
