...
public class DrinkTest extends AbstractItemTest {
	...
	public void setUp() throws Exception {
		StatModifyingItemProperties props1 = new StatModifyingItemProperties(WorldObjectType.FOOD, 1, "Apple Juice", 1, 1, 0, null, null, false, false, false, false, MIN_THIRST, MAX_THIRST);
		drink1 = new Drink(props1, 5);
		
		StatModifyingItemProperties props2 = new StatModifyingItemProperties(WorldObjectType.FOOD, 1, "Green Apple Juice", 1, 1, 0, null, null, false, false, false, false, MAX_THIRST, MAX_THIRST);
